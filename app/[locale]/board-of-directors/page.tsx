...
export default async function BoardOfDirectorsPage() {
  const t = await getPageText('/board-of-directors')
  return (
    <div className="flex-1 flex flex-col">
      <PageHeader
        eyebrow={t('header.eyebrow', 'Governance') as string}
        title={t('header.title', 'Board of Directors') as string}
        description={t('header.description', 'The Board of Astonea Labs Limited brings together executive leadership, non-executive oversight, and independent expertise.') as string}
        ...
        <div className="container-wide">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <Reveal delay={120}>
              ...
              >
                {composition.map((c, i) => (
                  <div key={i} className="p-7" style={{ background: 'var(--color-bg)' }}>
                    <CountUp
                      to={c.value}
        ...
        <div className="container-wide">
          <Reveal>
            <h2 className="mb-12 font-display text-2xl font-bold lg:text-3xl" style={{ color: 'var(--color-ink)' }}>
              {t('bod.meet_board.heading', 'Meet the Board')}
            </h2>
          </Reveal>
        ...
        <div className="container-wide">
          ...
          <Reveal delay={120}>
            ...
            >
              <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
                <div>
                  ...
                  <p className="mt-1 font-mono text-sm font-semibold" style={{ color: 'var(--color-ink)' }}>
                    {t('bod.cin_value', 'L24304CH2017PLC041482')}
                  </p>
                </div>
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-widest" style={{ color: 'var(--color-ink-subtle)' }}>
                    {t('bod.listing_label', 'Listing')}
                  </p>
                  <p className="mt-1 font-mono text-sm font-semibold" style={{ color: 'var(--color-ink)' }}>
                    {t('bod.listing_value', 'BSE SME')}
                  </p>
                </div>
                <p className="max-w-md text-sm leading-relaxed" style={{ color: 'var(--color-ink-muted)' }}>
                  {t('bod.footer_text', "For DIN numbers and complete regulatory disclosures, refer to the company's filings on the BSE platform.")}
                </p>
              </div>
              <Link
              ...
              >
                {t('bod.cta', 'Corporate Governance')}
