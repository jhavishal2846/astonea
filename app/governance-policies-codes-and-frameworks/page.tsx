...
const policies = [
  { title: 'Code of Conduct for Board & Senior Management', desc: 'Code of conduct applicable to all Directors, Key Managerial Personnel, and Senior Management personnel of the Company.' },
  { title: 'Whistle Blower Policy / Vigil Mechanism', desc: 'Policy enabling directors and employees to report genuine concerns without fear of victimization, in accordance with the Companies Act, 2013.' },
  ...
  { title: 'CSR Policy', desc: 'Corporate Social Responsibility policy outlining focus areas, governance, and spending norms in accordance with the Companies Act, 2013.' },
  ...
  { title: 'Insider Trading Code', desc: 'Code of practices and procedures for fair disclosure of unpublished price-sensitive information under SEBI (Prohibition of Insider Trading) Regulations, 2015.' },
  ...
  { title: 'Archival Policy', desc: 'Policy governing the retention and archival of documents and records in compliance with applicable laws and regulations.' },
]

const frameworks = [
  { title: 'SEBI LODR Framework', desc: 'Compliance framework under SEBI Listing Obligations and Disclosure Requirements Regulations 2015, governing continuing disclosure obligations.' },
  { title: 'Companies Act 2013 Compliance', desc: 'Governance framework aligned with the Companies Act 2013 and the Rules framed thereunder, including board governance and secretarial compliance.' },
  { title: 'SEBI Insider Trading Regulations', desc: 'Framework under SEBI (PIT) Regulations 2015 for prevention of insider trading and fair disclosure of material information.' },
  { title: 'Corporate Governance Report', desc: 'Quarterly / annual corporate governance report submitted to stock exchanges under Regulation 27(2) of SEBI LODR.' },
]
              ...
              <Reveal key={p.title} delay={i * 40}>
                <div className="flex items-start gap-4 p-5 rounded-xl border" style={{ background: 'var(--color-surface)', borderColor: 'var(--color-border)' }}>
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-sm mb-1" style={{ color: 'var(--color-ink)' }}>{p.title}</p>
                    <p className="text-xs leading-relaxed" style={{ color: 'var(--color-ink-muted)' }}>{p.desc}</p>
                  </div>
                  <span className="text-xs font-medium px-2.5 py-1 rounded-full flex-shrink-0" style={{ background: 'var(--color-primary-xlight)', color: 'var(--color-primary)' }}>
                    PDF
                  </span>
                </div>
              </Reveal>
      ...
      <section className="py-24 lg:py-32" style={{ background: 'var(--color-surface)' }}>
        <div className="container-wide">
          <Reveal>
            ...
            <h2 className="font-display text-3xl lg:text-4xl font-bold leading-snug mb-14 text-balance" style={{ color: 'var(--color-ink)' }}>
              Frameworks governing compliance
            </h2>
          </Reveal>
            ...
            {frameworks.map((f, i) => (
              <Reveal key={f.title} delay={i * 60}>
                <div className="p-8 rounded-2xl border h-full" style={{ background: 'var(--color-bg)', borderColor: 'var(--color-border)' }}>
                  <h3 className="font-display text-base font-semibold mb-3" style={{ color: 'var(--color-ink)' }}>{f.title}</h3>
