...
export const metadata: Metadata = {
  ...
  description: 'Disclosures of related party transactions of Astonea Labs Limited filed under Regulation 23 of SEBI LODR.',
}

type Item = { title: string; date?: string; fileUrl?: string }

const ITEMS: Item[] = [
  { title: 'RPT 31.03.2026 (HY)',     date: '31 Mar 2026', fileUrl: '/pdf/related-party-transactions/RPT.pdf' },
  { title: 'RPT 30.09.2025 (HY)',     date: '30 Sep 2025', fileUrl: '/pdf/related-party-transactions/RPT-Sep 25.pdf' },
  { title: 'RPT 31.03.2025 (Yearly)', date: '31 Mar 2025', fileUrl: '/pdf/related-party-transactions/RPT-Mar25 (Y).pdf' },
  { title: 'RPT 31.03.2025 (HY)',     date: '31 Mar 2025', fileUrl: '/pdf/related-party-transactions/RPT-Mar25 (HY).pdf' },
]
