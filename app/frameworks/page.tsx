...
const ITEMS: Item[] = [
  { title: 'Annual Performance Evaluation', fileUrl: '/pdf/Annual Performance Evaluation Framework.pdf' },
  { title: 'Board Evaluation Process',      fileUrl: '/pdf/Board Evaluation Process Document.pdf' },
]
