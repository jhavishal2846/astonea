...
export const metadata: Metadata = {
  ...
  description: 'Quarterly shareholding pattern of Astonea Labs Limited filed under Regulation 31 of SEBI LODR.',
}

type Item = { title: string; date?: string; fileUrl?: string }

const ITEMS: Item[] = [
  { title: 'Shareholding Pattern — HY 30.09.2025', date: '30 Sep 2025', fileUrl: '/pdf/shareholding-patternpage/Shareholding Pattern (1).pdf' },
  { title: 'Shareholding Pattern — HY 31.03.2026', date: '31 Mar 2026', fileUrl: '/pdf/shareholding-patternpage/Shareholding Pattern-31.03.2026 HY.pdf' },
]
